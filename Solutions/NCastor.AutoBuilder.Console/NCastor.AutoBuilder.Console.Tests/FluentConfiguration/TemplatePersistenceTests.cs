...
namespace NCastor.AutoBuilder.Console.Tests.FluentConfiguration
{
    ...
    public class TemplatePersistenceTests
    {
        ...
        {
            var cfg = CreateFullConfiguration("NCastor.AutoBuilder.Console.Templates");
        ...
        {
            var cfg = CreateFullConfiguration("NCastor.AutoBuilder.Console.Templates.Properties.Then.Nested");
        ...
        private TemplateConfigurator CreateFullConfiguration(string resourceNamespace = "NCastor.AutoBuilder.Console.Templates")
        {
